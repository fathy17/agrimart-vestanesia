  ...
  return (
    <Layout>
      <div>
        ...
        {/* Feature */}
        <div className="products container mx-auto my-16 p-4 lg:px-56 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 lg:gap-8 sm:gap-4 gap-4">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold my-4">24 Jam Customer Care</h3>
            <p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p>
              Vestanesia Agrimart menawarkan produk hasil pertanian lokal dalam
              rangka mendukung distribusikomoditas pertanian yang efisien.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="text-primary w-12 h-12 flex justify-center items-center rounded-full p-2 border-primary border-2">
        ...
        {/*Products*/}
        <div className="products container mx-auto my-24 p-4 lg:px-56 bg-gray-100 ">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 lg:gap-8 sm:gap-4 gap-4">
            {products.length
        ...
        {/* Invest Feature */}
        <div className="container mx-auto my-16 p-4 lg:px-56 ">
          <div className="relative">
            ...
            >
              ...
              <h4 className="text-xl mt-16 mb-4">kunjungi</h4>
